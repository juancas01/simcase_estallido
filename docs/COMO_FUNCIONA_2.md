# Cómo funciona · Parte 2 — Del juego al motor

Cómo está construido el simulador de la [propuesta v2](propuesta_v2.md), leído
...
La [parte 1](COMO_FUNCIONA.md) describe el motor anterior. Este documento
describe **el motor v2**, que es el que corre hoy.
...
El [diagnóstico del motor anterior](mapa_de_palancas.md) encontró siete
...
[`propuesta_v2.md`](propuesta_v2.md); diagnóstico del motor anterior en
